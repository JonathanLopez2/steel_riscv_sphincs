...
HD_PWD='C:/Users/Jonathan/OneDrive/Escritorio/steel_spx_haraka/steel_spx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log steel_spx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source steel_spx.tcl
